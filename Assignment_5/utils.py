    ...
    for sent in sents:
        ...
        for word in sent:
            ...
            if len(word)<max_word_length:
                ...
                word1.extend(padding)
            elif len(word)>max_word_length:
                word1 = word[0:max_word_length]
            sent1.append(word1)
        for i in range(0,max_len-len(sent),1):
            sent1.append(word_temp)
        sents_padded.append(sent1)
